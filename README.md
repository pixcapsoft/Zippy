...
⚠️ **Warning:** Zippy for Linux & macOS is not tested by the developer. It may not work as expected. It is recommended to build Zippy on your own system. Windows versions are already tested!
...
3. Build for your platform:
   ...
   **Note:** If you build Zippy from source code to create your own application, you cannot use "Zippy" as the name for it, as mentioned in the [LICENSE](LICENSE). The original Zippy name is copyrighted by PixCap Soft.
